  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学院名称" prop="academyName">
        <el-input
          v-model="queryParams.academyName"
          placeholder="请输入学院名称"
          clearable
...
<script>
import { listAcademy, getAcademy, delAcademy, addAcademy, updateAcademy } from "@/api/team/academy";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('team/academy/export', {
        ...this.queryParams
